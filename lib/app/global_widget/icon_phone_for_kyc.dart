...
class IconPhoneForKyc extends StatelessWidget {
  const IconPhoneForKyc({super.key, this.img, this.width, this.height});
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Container(
        height: height ?? AppDismens.size145,
        width: width ?? AppDismens.size145,
        ...
        child: Center(
          child: Container(
            height: AppDismens.size120,
            width: AppDismens.size120,
            decoration: BoxDecoration(
