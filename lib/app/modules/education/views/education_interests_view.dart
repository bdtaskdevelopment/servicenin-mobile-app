  ...
  Widget build(BuildContext context) {
    return ListView(
      children: [
        ...
        Center(
          child: Text(
            'Courses you register interest in appear here.'.tr,
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      courseTitle.isNotEmpty ? courseTitle : 'Course'.tr,
                      style: const TextStyle(
                        fontSize: 15,
                        fontWeight: FontWeight.w800,
                        color: Color(0xFF0F172A),
          ...
          Container(
            ...
            child: Column(
              children: [
                _row('Student'.tr, item.studentName),
                if (item.subjectNeeded.isNotEmpty) ...[
                  const SizedBox(height: 8),
                  _row('Subject'.tr, item.subjectNeeded),
                ],
                if (item.preferredTime.isNotEmpty) ...[
                  const SizedBox(height: 8),
                  _row('Time'.tr, item.preferredTime),
                ],
                if (item.parentContact.isNotEmpty) ...[
                  const SizedBox(height: 8),
                  _row('Contact'.tr, item.parentContact),
                ],
              ],
            ),
          ),
