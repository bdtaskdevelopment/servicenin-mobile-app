...
/// Standalone "Support tickets" list — surfaced like "My reports" so users can
/// find their tickets easily (no longer buried as a tab).
class NagarikTicketsView extends GetView<NagarikController> {
  const NagarikTicketsView({super.key});
